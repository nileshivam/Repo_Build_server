...
namespace MessagePassingComm
{
  ...
  public interface IMessagePassingComm
  {
    ...
    [OperationContract]
    bool openFileForWrite(string dest,string name);
  ...
  public class CommMessage
  {
    public enum MessageType
    {
      ...
      [EnumMember]
      ready,            //Indicate Sender is ready
      [EnumMember]
      buildRequest,     //Send messege in form of BuildRequest 
      [EnumMember]
      quit              //Close the receiver process
    }
